...
urlpatterns = [
    ...
    path("income-vs-expense-data/", views.income_vs_expense_data, name="income_vs_expense_data"),
    path('bulk-import/', views.bulk_import_income, name='bulk-import-income'),
    path('bulk-delete/', views.bulk_delete_income, name='bulk-delete-income'),
]
